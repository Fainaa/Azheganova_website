...
function isAngleCorrect(el) {
  ...
  if (el.classList.contains('green1') || el.classList.contains('green2') || el.classList.contains('green3') || el.classList.contains('brown-triangle')) {
...
function isHouseComplete() {
  ...
  const blueInside = rectB.left > rectR.left + 20 && rectB.right < rectR.right - 20 && rectB.top > rectR.top + 20 && rectB.bottom < rectR.bottom - 20 && blueCenteredX && blueCenteredY;
...
function checkDetailedPositioning() {
  return isTreeComplete() && isHouseComplete();
}
